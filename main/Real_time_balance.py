...
# Loop through the provided balance data
          ...
          print(Fore.GREEN + "real time account has been checked")
          return extracted_balances
            

        else:
            print(Fore.RED +f"error getting real time balance {account_data}")
